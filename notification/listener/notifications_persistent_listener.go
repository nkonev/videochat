...
type NotificationsPersistentListener func(*amqp.Delivery) error

func CreateNotificationsPersistentListener(service *services.NotificationPersistentService, lgr *logger.Logger) NotificationsPersistentListener {
