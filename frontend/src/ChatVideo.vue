    ...
    export default {
        ...
        methods: {
            joinSession() {
                ...
                this.OV.setAdvancedConfiguration({iceServers: [{urls: ["turn:api.site.local:3478", "stun:api.site.local:3478"], username: "scott", credential: "tiger"}], forceMediaReconnectionAfterNetworkDrop: true})
