        ...
        <v-dialog v-model="show" max-width="640" scrollable>
            <v-card>
                ...
                <v-card-text class="ma-0 pa-0">
                    <v-list class="pb-0">
                        <v-list-item link>
                            <v-list-item-icon class="mr-4"><v-icon large>mdi-at</v-icon></v-list-item-icon>
                            <v-list-item-content class="py-2">
                                ...
                                <v-list-item-subtitle>{{ $vuetify.lang.t('$vuetify.notification_mention') }}</v-list-item-subtitle>
                        ...
                        <v-list-item link>
                            <v-list-item-icon class="mr-4"><v-icon large>mdi-phone-missed</v-icon></v-list-item-icon>
                            <v-list-item-content class="py-2">
                                <v-list-item-title>chat 2</v-list-item-title>
                                <v-list-item-subtitle>{{ $vuetify.lang.t('$vuetify.notification_missed_call') }}</v-list-item-subtitle>
                                <v-list-item-subtitle>
                                    05:18:39, 22 Nov 2022
                                </v-list-item-subtitle>
                        ...
                        <v-list-item link>
                            <v-list-item-icon class="mr-4"><v-icon large>mdi-phone</v-icon></v-list-item-icon>
