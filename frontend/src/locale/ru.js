...
export default {
    ...
    unpublish_message: "Отменить публикацию",
    ...
    video_presenter_enable: "Показать презентатор",
    close_video: "Закрыть видео",
    video_presenter_disable: "Скрыть презентатор",
    pin_video: "Закрепить это видео",
    unpin_video: "Открепить видео",
    video_miniatures_disable: "Скрыть видео миниатюры",
    video_miniatures_enable: "Показать видео миниатюры",
    video_messages_disable: "Скрыть сообщения",
    video_messages_enable: "Показать сообщения",
    logs: "Логи",
    ...
    message_delete_with_attached_files: "Удалить с файлами"
}
