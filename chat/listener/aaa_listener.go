...
func CreateAaaUserProfileUpdateListener(lgr *log.Entry, not *services.Events, typeRegistry *type_registry.TypeRegistryInstance, db *db.DB) AaaUserProfileUpdateListener {
