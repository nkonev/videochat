CREATE OR REPLACE FUNCTION CREATE_CHAT(IN chat_name TEXT) RETURNS RECORD AS $$
    DECLARE
        chat_id BIGINT;
        ...
        ret RECORD;
    BEGIN
        INSERT INTO chat(title) VALUES(chat_name) RETURNING id, last_update_date_time INTO chat_id, chat_last_update_date_time;
