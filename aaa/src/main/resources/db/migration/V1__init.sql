...
INSERT INTO users (id, username, password, avatar, enabled, expired, locked, email, role, creation_type, facebook_id, vkontakte_id, last_login_date_time) VALUES
 ...
 -- bcrypt('admin', 10)
 (1, 'admin', '${admin.password}', 'https://cdn3.iconfinder.com/data/icons/rcons-user-action/32/boy-512.png', true, false, false, 'admin@example.com', 'ROLE_ADMIN', 'REGISTRATION', NULL, NULL, NULL);
