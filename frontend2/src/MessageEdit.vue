                ...
                <div class="d-flex flex-wrap flex-row dashed-borders">
                    <div style="max-width: 100%" v-if="$refs.tipTapRef">
                        <v-slide-group
                            ...
                            show-arrows
                        >
                            <v-btn icon :large="isMobile()" tile :input-value="boldValue()" @click="boldClick" :width="getBtnWidth()" :color="boldValue() ? 'black' : ''" :title="$vuetify.locale.t('$vuetify.message_edit_bold')">
                                <v-icon :large="isMobile()">mdi-format-bold</v-icon>
                            </v-btn>

                            <v-btn icon :large="isMobile()" tile :input-value="italicValue()" @click="italicClick" :width="getBtnWidth()" :color="italicValue() ? 'black' : ''" :title="$vuetify.locale.t('$vuetify.message_edit_italic')">
                                <v-icon :large="isMobile()">mdi-format-italic</v-icon>
                            </v-btn>

                            <v-btn icon :large="isMobile()" tile :input-value="underlineValue()" @click="underlineClick" :width="getBtnWidth()" :color="underlineValue() ? 'black' : ''" :title="$vuetify.locale.t('$vuetify.message_edit_underline')">
                                <v-icon :large="isMobile()">mdi-format-underline</v-icon>
                            </v-btn>

                            <v-btn icon :large="isMobile()" tile :input-value="strikeValue()" @click="strikeClick" :width="getBtnWidth()" :color="strikeValue() ? 'black' : ''" :title="$vuetify.locale.t('$vuetify.message_edit_strike')">
                                <v-icon :large="isMobile()">mdi-format-strikethrough-variant</v-icon>
                            </v-btn>

                            <v-btn icon :large="isMobile()" tile :input-value="codeValue()" @click="codeClick" :width="getBtnWidth()" :color="codeValue() ? 'black' : ''" :title="$vuetify.locale.t('$vuetify.message_edit_code')">
                                <v-icon :large="isMobile()">mdi-code-braces</v-icon>
                            </v-btn>

                            <v-btn icon :large="isMobile()" tile :input-value="linkValue()" :disabled="linkButtonDisabled()" @click="linkClick" :width="getBtnWidth()" :color="linkValue() ? 'black' : ''" :title="$vuetify.locale.t('$vuetify.message_edit_link')">
                                <v-icon :large="isMobile()">mdi-link-variant</v-icon>
                            </v-btn>

                            <v-btn icon :large="isMobile()" tile @click="imageClick" :width="getBtnWidth()" :title="$vuetify.locale.t('$vuetify.message_edit_image')">
                                <v-icon :large="isMobile()">mdi-image-outline</v-icon>
                            </v-btn>

                            <v-btn icon :large="isMobile()" tile @click="videoClick" :width="getBtnWidth()" :title="$vuetify.locale.t('$vuetify.message_edit_video')">
                                <v-icon :large="isMobile()">mdi-video</v-icon>
                            </v-btn>

                            <v-btn icon :large="isMobile()" tile @click="embedClick" :width="getBtnWidth()" :title="$vuetify.locale.t('$vuetify.message_edit_embed')">
                                <v-icon :large="isMobile()">mdi-youtube</v-icon>
                            </v-btn>

                            <v-btn icon :large="isMobile()" tile @click="textColorClick" :width="getBtnWidth()" :title="$vuetify.locale.t('$vuetify.message_edit_text_color')">
                                <v-icon :large="isMobile()">mdi-invert-colors</v-icon>
                            </v-btn>

                            <v-btn icon :large="isMobile()" tile @click="backgroundColorClick" :width="getBtnWidth()" :title="$vuetify.locale.t('$vuetify.message_edit_background_color')">
                                <v-icon :large="isMobile()">mdi-format-color-fill</v-icon>
                            </v-btn>

                            <v-btn icon :large="isMobile()" tile @click="smileyClick" :width="getBtnWidth()" :title="$vuetify.locale.t('$vuetify.message_edit_smiley')">
                    ...
                    <div class="custom-toolbar-send">
                        <v-btn v-if="!this.editMessageDto.fileItemUuid" icon tile :large="isMobile()" :width="getBtnWidth()" @click="openFileUpload()" :title="$vuetify.locale.t('$vuetify.message_edit_file')"><v-icon :large="isMobile()" color="primary">mdi-file-upload</v-icon></v-btn>
                        <template v-if="this.editMessageDto.fileItemUuid">
                            <v-badge
                                ...
                                left
                            >
                                <v-btn icon tile :large="isMobile()" :width="getBtnWidth()" @click="onFilesClicked()" :title="$vuetify.locale.t('$vuetify.message_edit_attached_files')"><v-icon :large="isMobile()">mdi-file-document-multiple</v-icon></v-btn>
                            </v-badge>
                        </template>
                        <v-btn icon tile :large="isMobile()" :width="getBtnWidth()" class="mr-2" @click="resetInput()" :title="$vuetify.locale.t('$vuetify.message_edit_clear')"><v-icon :large="isMobile()">mdi-delete</v-icon></v-btn>
                        ...
                        ></v-switch>
                        <v-btn color="primary" @click="sendMessageToChat" tile class="mr-0 send" :title="$vuetify.locale.t('$vuetify.message_edit_send')" :disabled="sending" :loading="sending"><v-icon color="white">mdi-send</v-icon></v-btn>
                    </div>
